...
public class ModItems {
	...
	public static final Item PYTHON_PENDRIVE = registerItem("python_pendrive", new PythonPendriveItem(new Item.Settings().maxCount(1).registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(DroneboxMain.MOD_ID,"python_pendrive")))));
