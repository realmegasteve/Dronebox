...
public class DroneControllerItemServer extends Item {
	...
	public DroneControllerItemServer(Settings settings) {
		super(settings);
	}
	...
	@Override
	public net.minecraft.util.ActionResult use(World world, PlayerEntity player, net.minecraft.util.Hand hand) {
